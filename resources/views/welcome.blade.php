...
<body class="antialiased">
    ...
    <div>
        <img src="{{ Storage::disk('s3')->url('cursos/test_image.jpg') }}" width="200px" alt="" srcset="">
        <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/06/6c/56/bd.jpg" width="200px" alt=""
            srcset="">
    </div>
</body>
